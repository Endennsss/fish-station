...
/// <summary>Локальное исчезновение собранного спрайта через индивидуальный PostShader.</summary>
public sealed class DissolveSystem : EntitySystem
{
    ...
    private static readonly ProtoId<ShaderPrototype> ShaderId = "FishDissolve";
    ...
    /// <summary>Исчезновение 0 → 1. По завершении скрывается только клиентский спрайт.</summary>
    ...
    /// <summary>Материализация 1 → 0 с восстановлением исходного состояния.</summary>
    ...
    /// <summary>Устанавливает статическую фазу для предпросмотра. Reset снимает эффект.</summary>
    ...
    /// <summary>Отменяет анимацию и восстанавливает исходную видимость.</summary>
